...
### How do I get the Python/Pip installed?

If you don't have the right version of python on your system, you will need to do some
troubleshooting. For those unfamiliar with Python, here are some helpful pointers depending on 
your OS:
...
* Now use the auto-installer script (https://github.com/pyenv/pyenv-installer):
    ```sh
    curl https://pyenv.run | bash
    ```
...
* Go to https://www.python.org/downloads/windows/ and download the desired version's installer.
...
* Once the install is complete, open the command prompt and install NLoed with pip with:
    ```sh
    pip install nloed
    ```
