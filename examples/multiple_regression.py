...
theta2 = cs.Function('theta2',[beta,x],[beta[1] + x[3]*beta[2] + x[2]*beta[4])
...
model1={'Model':linear2dx2d, 'Beta': [1, 1, 1, 1]}
model2={'Model':linear2dx2d, 'Beta': [2, 2, 2, 2]}
...
#NOTE: Add to exact later: Replicates, Constraints, Start
obs=[('y1','y2')]
#NOTE: Add to obs later: Weights

xi=design(models,exact,approx,obs)
